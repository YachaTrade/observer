...
use crate::{
    db::postgres::PostgresDatabase, measure_postgres, types::v2::vault_registry::VaultMetadata,
};
...
pub struct V2VaultRegistryController {
    pub db: Arc<PostgresDatabase>,
}

impl V2VaultRegistryController {
    pub fn new(db: Arc<PostgresDatabase>) -> Self {
        V2VaultRegistryController { db }
    }
