...
use crate::{
    db::postgres::{
        PostgresDatabase,
        controller::{
            CreatorFeeClaimData, CreatorUpdateData, DividendClaimData, DividendController,
            DividendConversionData, DividendDepositData, DividendMerkleRootData, DividendSetupData,
            GiftData, GiftExpiryUpdateData, VaultBurnData, VaultController, VaultLpInjectData,
...
pub async fn process_events(
    ...
    let controller = VaultController::new(db.clone());
    let dividend_controller = DividendController::new(db.clone());
    ...
    for event in events {
        match event {
            ...
            VaultEvent::CreatorVaultSetup(e) => {
                account_ids.insert((*e.creator).clone());
            ...
            VaultEvent::Dividend(de) => match de {
                DividendEvent::Setup(e) => {
