...
use crate::{
    ...
    sync::EventType,
    types::vault::VaultEvent,
};

use crate::event::handler::{EventHandler, run_event_handler};
pub type VaultEventBatch = AcknowledgedEventBatch<VaultEvent>;
pub type VaultEventChannel = AcknowledgedEventChannel<VaultEvent>;

pub struct VaultEventHandler;

impl EventHandler for VaultEventHandler {
    type Event = Vec<VaultEvent>;
