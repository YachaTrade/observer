...
use crate::{
    ...
    sync::EventType,
    types::vault_registry::VaultRegistryEvent,
};

use crate::event::handler::{EventHandler, run_event_handler};

pub type VaultRegistryEventBatch = AcknowledgedEventBatch<VaultRegistryEvent>;
pub type VaultRegistryEventChannel = AcknowledgedEventChannel<VaultRegistryEvent>;

pub struct VaultRegistryEventHandler;

impl EventHandler for VaultRegistryEventHandler {
    type Event = Vec<VaultRegistryEvent>;
