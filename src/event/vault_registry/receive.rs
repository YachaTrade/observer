...
use crate::{
    db::postgres::{
        PostgresDatabase,
        controller::{
            VaultActiveData, VaultMetadataData, VaultRegistryController, VaultRegistryEventData,
        },
    },
...
async fn process_events(
    ...
    for event in events {
        match event {
            ...
            VaultRegistryEvent::Deactivate(e) => {
